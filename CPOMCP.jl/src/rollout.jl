...
"""
function estimate_value(estimator::SolvedFOValue, pomdp::CPOMDPs.CPOMDP, start_state, h::BeliefNode, steps::Int)
...
"""
function rollout(est::SolvedPORollout, pomdp::CPOMDP, start_state, h::BeliefNode, steps::Int)
...
@POMDP_require rollout(est::SolvedPORollout, pomdp::CPOMDP, start_state, h::BeliefNode, steps::Int) begin
...
function rollout(est::SolvedFORollout, pomdp::CPOMDP, start_state, h::BeliefNode, steps::Int)
    sim = ConstrainedRolloutSimulator(est.rng, steps)
    return simulate(sim, pomdp, est.policy, start_state)
end

@POMDP_require rollout(est::SolvedFORollout, pomdp::CPOMDP, start_state, h::BeliefNode, steps::Int) begin
    sim = ConstrainedRolloutSimulator(est.rng, steps)
