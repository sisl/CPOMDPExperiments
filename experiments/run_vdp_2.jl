...
if run[3] # PFT
    ...
    print_and_save(exp3,"results/vdp_pft_$(nsims)sims_2.jld2")
end
...
if run[1] # POMCPOW
    ...
    print_and_save(exp1,"results/vdp_pomcpow_$(nsims)sims_2.jld2")
end
...
if run[2] # POMCP
    ...
    print_and_save(exp2,"results/vdp_pomcpdpw_$(nsims)sims_2.jld2")
end
