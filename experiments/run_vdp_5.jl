...
if run[1] # POMCPOW
    ...
    print_and_save(exp1,"results/vdp_pomcpow_$(nsims)sims_5.jld2")
end
...
if run[2] # POMCP
    ...
    print_and_save(exp2,"results/vdp_pomcpdpw_$(nsims)sims_5.jld2")
end
...
if run[3] # PFT
    kwargs = Dict(
        ...
        :k_state => k_o_pft, 
        :alpha_state => alpha_o_pft, 
        :k_action => k_a_pft, 
        :alpha_action => alpha_a_pft, 
        :check_repeat_state => false,
        :check_repeat_action => false,
        :depth => max_depth,
        :exploration_constant => c_pft,
        :nu => nu, 
    ...
    print_and_save(exp3,"results/vdp_pft_$(nsims)sims_5.jld2")
end